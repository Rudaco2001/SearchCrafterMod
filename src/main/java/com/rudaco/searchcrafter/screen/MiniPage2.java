...
public class MiniPage2 extends MenuChestPage{
    CraftableMenu menu;
    public MiniPage2(CraftableMenu menu, SearchCrafterTableScreen screen, int pageNumber, int objectCont, int pageSizeX, int pageSizeY, ArrayList<CraftableInfo> elements, int maxPage) {
    ...
    public void renderButtons(){
        ...
        for (CraftableInfo info: craftableList){
            ...
            drawItemButton(x+3, y+(y_size*i)+5, (pageSizeX-6), y_size, itemName + " x" + info.quant, ()->{},0);
            i++;
        }
