...
public class MiniPage2 extends MenuChestPage{
    CraftableMenu menu;
    public MiniPage2(CraftableMenu menu, SearchCrafterTableScreen screen, int pageNumber, int objectCont, int objectCount_x,  int pageSizeX, int pageSizeY, ArrayList<CraftableInfo> elements, int maxPage) {
